...
4. When creating them respect the test case fields rules

return the created test case list in table format with: id, title, priority, technique, tag and url in a table format
